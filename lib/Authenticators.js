...
//Shopify.Authenticators = {
//    Public: {
//        // This is the easiest-to-use authenticator.
//        //
//        // @param options {Object}
//        // @param options.shop {String}
//        // @params option.api_key {String}
//        // @params options.secret {String}
//        // @params [options.scopes] {String}
//        // @params [options.post_auth_uri] {String}
//        // @params [onAuth] {Function}
...
//            this.config.onAuth = options.onAuth || function() { };
//
//            // Tell shopify to redirect the user to this address after
//            // authentication.
//            this.redirect_uri = Meteor.absoluteUrl("__shopify-auth/" + Meteor.uuid());
//
//            // Navigating here lets the user login and install the app.
//            this.auth_uri = [
//                "https://",
...
//            ].join("");
//
//            // Install the redirect_uri handler server-side.
//            Meteor.call("__ShopifyHandleAuthRedirect", this.config, function(err, access_token) {
//                if (err) {
//                    throw new Error("Auth failed: " + err);
//                }
//
//                self.config.access_token = access_token;
//                self.config.onAuth(self.access_token);
//            });
//
//            // Open a new tab where the user can install the app and grant it
//            // permission.
//            this.openAuthTab = function() {
//                if (!Meteor.isClient) {
//                    throw new Error("Can only open a new tab client-side.");
//                }
//
//                window.open(self.auth_uri, "_blank");
//            };
//
//            this.authenticate = function(req) {
//                if (!self.access_token) {
//                    throw new Error("Cannot authenticate.  No access_token.  Navigate using `authenticator.openAuthTab` or navigating manually to `authenticator.auth_uri` directly or in an iframe.");
//                }
//
//                if (!req.headers) {
//                    req.headers = { };
...
//            };
//        },
//        Manual: function(shop, api_key, secret, scopes, redirect_uri) {
//            this.type = "public";
//        },
//    }
//};
